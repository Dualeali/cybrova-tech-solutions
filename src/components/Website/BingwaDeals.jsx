...
import { Wifi, Phone, Clock, MessageCircle, ChevronRight, CheckCircle2, ShoppingCart, Copy, Check } from 'lucide-react';
                    ...
                    <div className="flex flex-col md:flex-row gap-12 items-center">
                        <div className="md:w-1/3">
                            ...
                            <motion.button 
                                ...
                                whileTap={{ scale: 0.95 }}
                                className={`w-full p-4 border rounded-xl flex flex-col items-center justify-center transition-all mt-4 ${copied ? 'bg-green-500/20 border-green-400 shadow-[0_0_20px_rgba(0,255,136,0.3)]' : 'bg-brand-dark/80 border-brand-neon/30 hover:shadow-[0_0_15px_rgba(0,255,136,0.2)]'}`}
                            >
