                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    {stats.map((stat, index) => (
                        <motion.div
                            ...
                            className="flex flex-col items-center text-center p-6 bg-white/5 border border-white/10 rounded-3xl backdrop-blur-md hover:bg-white/10 hover:border-lime-400/30 transition-all duration-300"
                        >
                            <div className="mb-4 p-4 rounded-2xl bg-black/50 shadow-inner">
                                {stat.icon}
                            </div>
                            <div className="text-4xl md:text-5xl font-extrabold text-white font-outfit mb-2 drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]">
                                {stat.value}
                            </div>
